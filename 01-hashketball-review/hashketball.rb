...
def find_player(player_name)
  ...
  # lookup the player in all players
  # return player if name matches
  all_players.find { |player| player[:player_name] == player_name }
end


def num_points_scored(player_name)
  # return the score of the player whose name matches the argument 'player_name'
...
def shoe_size(player_name)
  # return the shoe size of the player whose name matches the argument 'player_name'
  # player = all_players.find do |player|
  #   player[:player_name] == player_name
  # end
  # player[:shoe]
